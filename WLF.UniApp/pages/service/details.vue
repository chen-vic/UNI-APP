<template>
	<view>
		<!--banner-->
		<view class="wrapper">
			<image :src="imgUrl+ items.service_img || '/static/default_detail.png'" mode="aspectFill"></image>
		</view>

		<!--标题-->
		<view class="info">
			<view class="title">
				<text>{{ items.service_title }}</text>
		...
		<view class="article-meta">
			<view class="article-meta-text article-title">服务介绍</view>
		</view>
		<view class="article-content">
			<view class="text-dark">
				<rich-text :nodes="items.service_content"></rich-text>
			</view>
			<view class="font-sm text-light-muted mt-2" style="display: none;">发布日期：{{ items.created_at }}</view>
		</view>
		<!-- 预约报名 -->
		...
		<view class="page-bottom" v-else>
			<button @click="toOrderService" type="warn" class=" action-btn no-border add-now-btn">预约服务</button>
		</view> -->
